...
// var_dump(password_hash('Test1234!', PASSWORD_ARGON2I));

require_once '/app/Requests/users.php';


// Verifier si le formulaire a été soumis et que les données ne sont pas vide
if (
    !empty($_POST['email']) &&
    ...
    // Récupéreer  l'utilisateur en BDD
